const FriendComponent = (props:any) => {
    return (
        <>
          <button className="flex items-center w-full px-5 py-2 transition-colors duration-200 dark:hover:bg-gray-900 gap-x-2 hover:bg-gray-100 focus:outline-none">
                ...
                <div className="flex flex-row text-left rtl:text-right">
