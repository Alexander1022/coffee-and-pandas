                ...
                <div className="flex flex-row auto-cols-max gap-x-2 justify-center">
                    ...
                    <div className="bg-white w-1/2 h-full">
                        <div className='bg-[#333333] px-10 space-y-3'>
                            ...
                            <CenteredCard title="Лудо парти с Ивака в Луксозенец" desc="Само GUCCI тигри могат да дойдат!"/>

                            <CenteredCard title="Щурм на луди математици пред ФМИ" desc="Хайде елате!!"/>
                        </div>
                    </div>
